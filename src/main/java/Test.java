...
public class Test{
    ...
    public static void big_test_ACS(){
        System.out.println("this is acs test");
        num_ants = 20;
        max_iterations = 30;
        alpha = 1;
        beta = 2;
        ...
        TSP problem = new TSP("d2103.tsp", num_ants, 80450);
        int termination_condition = 3;
        ACS acs = new ACS(problem, num_ants, max_iterations, alpha, beta, evaporation_factor, epsilon, termination_condition);
        ...
        System.out.println("filename is dl2103.tsp");
        System.out.println("Time take to execute eas:  " + duration);
        System.out.println("avg iteration where max was found:  " + acs.best_iter);
        System.out.println("EAS best length average over 10 iterations: " + acs.get_best_length());
        System.out.println("-----------------------------------------------------------------------------");
        System.out.println("-----------------------------------------------------------------------------");
        System.out.println("-----------------------------------------------------------------------------");
        ...
        problem = new TSP("pcb3038.tsp", num_ants, 137694);
        termination_condition = 3;
        acs = new ACS(problem, num_ants, max_iterations, alpha, beta, evaporation_factor, epsilon, termination_condition);
    ...
    public static void testing(){
        ...
        for(int i = 0; i < alpha_changes.length; i++){
            ...
            for(int j = 0; j < 10; j++) {
                ...
                TSP problem = new TSP("pr124.tsp", num_ants, 426.0);
                int termination_condition = 3;
        ...
        System.out.println("----------------------------------------------");
        System.out.println("----------------------------------------------");
        System.out.println("Now Printing ACS results");
        System.out.println("----------------------------------------------");
        System.out.println("----------------------------------------------");
        ...
        for(int i = 0; i < alpha_changes.length; i++){
            ...
            for(int j = 0; j < 10; j++) {
                ...
                ACS acs = new ACS(problem, num_ants, max_iterations, alpha_changes[i], beta, evaporation_factor, epsilon, termination_condition);
                ...
                avg_time += duration;
                avg_best_iterations += acs.best_iter;
                avg_best_length += acs.get_best_length();
            }
            System.out.println();
            System.out.println("Average time taken to execute acs in seconds:  " + avg_time/10);
            ...
            System.out.println("Average ACS Best: " + avg_best_length/10);
            System.out.println();
        ...
        for(int i = 0; i < beta_changes.length; i++){
            ...
            for(int j = 0; j < 10; j++) {
                ...
                ACS acs = new ACS(problem, num_ants, max_iterations, alpha, beta_changes[i], evaporation_factor, epsilon, termination_condition);
        ...
        for(int i = 0; i < epsilon_changes.length; i++){
            ...
            for(int j = 0; j < 10; j++) {
                ...
                ACS acs = new ACS(problem, num_ants, max_iterations, alpha, beta, evaporation_factor, epsilon_changes[i], termination_condition);
            ...
            System.out.println();
            System.out.println("Average time taken to execute acs in seconds:  " + avg_time/10);
            System.out.println("ACS with this variable for Epsilo :  " + epsilon_changes[i]);
            System.out.println("Average iteration where max was found:  " + avg_best_iterations/10);
            System.out.println("Average ACS Best: " + avg_best_length/10);
            System.out.println();
    ...
    public static void big_testing(){
        num_ants = 10;
        max_iterations = 25;
        alpha = 1;
        beta = 2;
        ...
        for(int j = 0; j < 5; j++) {
            ...
            TSP problem = new TSP("pr264.tsp", num_ants, 426.0);
            int termination_condition = 3;
        ...
        System.out.println();
        System.out.println("Average time taken to execute eas in seconds:  " + avg_time/10);
        System.out.println("Average iteration where max was found:  " + avg_best_iterations/10);
        System.out.println("Average ACS Best: " + avg_best_length/10);
        System.out.println();
